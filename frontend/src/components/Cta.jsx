...
const Cta = () => {
  return (
    <div className='container mx-auto flex flex-col gap-5 items-center justify-center py-20' id='cta'>
        <p className=' text-xl md:text-2xl lg:text-4xl font-medium text-center'>Start with Eudaimonia today.</p>
        ...
        <div className="flex flex-row gap-3 sm:gap-5 lg:gap-10 items-center mt-5">
            ...
            <button className='btn btn-sm lg:btn-lg bg-dark text-white btn-lg rounded-full border-none px-10 py-2'>Send</button>
        </div>
    </div>
  )
}
